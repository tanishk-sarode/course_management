...
# from fastapi.security import HTTPBearer, HTTPBasicCredentials, HTTPAuthCredentials
...
#     Returns:
#         User if they have instructor or admin role
        
#     Raises:
#         HTTPException: If user doesn't have instructor or admin role
#     """
#     if current_user.role not in ["instructor", "admin"]:
#         raise HTTPException(
#             status_code=status.HTTP_403_FORBIDDEN,
#             detail="This endpoint requires instructor or admin role",
#         )
#     return current_user
